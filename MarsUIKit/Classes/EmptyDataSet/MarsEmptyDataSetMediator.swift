//
//  MarsEmptyDataSetMediator.swift
//  MarsUIKit
//
...
@objc public protocol MarsEmptyDataSetPresentable: AnyObject {
    var listView: UIScrollView? { get set }
}

public class MarsEmptyDataSetMediator: NSObject, MarsEmptyDataSetPresentable {
    ...
    @objc public var style: MarsEmptyDataSetStyle = MarsEmptyDataSetStyle()
...
extension MarsEmptyDataSetMediator: DZNEmptyDataSetDelegate, DZNEmptyDataSetSource {
