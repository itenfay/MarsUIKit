...
public class MarsEmptyDataSetStyle: NSObject {
    ...
    @objc public var backgroundColor: UIColor = UIColor.ms_color(hexString: "#FFFFFF")!
    /// The title for empty data set.
    @objc public var title: String?
    /// The title color for empty data set.
    @objc public var titleColor: UIColor = UIColor.ms_color(hexString: "#333333")!
    ...
    @objc public var descriptionColor: UIColor = UIColor.ms_color(hexString: "#333333")!
    ...
    @objc public var buttonColor: UIColor = UIColor.ms_color(hexString: "#9D1420")!
