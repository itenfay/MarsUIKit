//
//  MarsEmptyDataSetDecorator.swift
//  MarsUIKit
//
...
@objc public protocol MarsEmptyDataPresentable: AnyObject {
    var listView: UIScrollView? { get set }
}

public class MarsEmptyDataSetDecorator: NSObject, MarsEmptyDataPresentable {
...
extension MarsEmptyDataSetDecorator: DZNEmptyDataSetDelegate, DZNEmptyDataSetSource {
